  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: isProgress ? CommonFunction.showProgress(true) : ListView(
          children: [
            SizedBox(
              height: 10,
            ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Visibility(
                        visible: confirmNewPassError.isEmpty ? false : true,
                        child: Container(
                          margin: EdgeInsets.only(top: 5),
                          child: Text(
                            confirmNewPassError,
      ...
      bottomNavigationBar: GestureDetector(
        onTap: () async {
          if (oldPassController.text.isEmpty) {
            ...
            param['password_confirmation'] = confirmNewPassController.text.toString();
